    ...
    <article className="mx-auto max-w-3xl px-5 py-12">
      ...
      <div className="mt-8 space-y-8 text-[15px] leading-loose text-ink-soft">
        ...
        <section>
          ...
          <p className="mt-3">
            対策の柱は3つです。1つ目は、サービスごとに完全に別のパスワードを使うこと。2つ目は、それを記憶に頼らず<Link href="/column/password-manager/" className="text-shu underline underline-offset-2">パスワードマネージャー</Link>に保存すること。3つ目は、二段階認証を有効にすることです。特に二段階認証は、仮にパスワードが漏れても、それだけではログインさせない最後の砦になります。重要なアカウント（メール、決済、SNS）から順に設定していくのが効率的です。
          </p>
          <p className="mt-3">
